class Admin::StudyCategoriesController < Admin::BaseController
  ...
  def create
    ...
    if @study_category.save
      redirect_to admin_study_categories_path, notice: 'Study category was successfully created.'
    else
      render action: "new"
    end
  end
  ...
  def update
    if @study_category.update_attributes(params[:study_category])
      redirect_to admin_study_categories_path, notice: 'Study category was successfully updated.'
    else
      render action: "edit"
    end
