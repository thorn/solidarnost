...
class FamilySearch
  def self.search(par)
    ...
    if par[:with_one_parent]
      par[:search][:children_counter_equals] = 0
      par[:search][:mother_counter_or_father_counter_equals] = 0
      ...
      par[:search][:children_counter_and_mother_counter_and_father_counter_equals] = 0
